...
public class Performance_Chart extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_performance__chart);
        ...
        mView.setOnNavigationItemSelectedListener(Performance_Chart.this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_home:
                ...
                Intent intent_1 = new Intent(Performance_Chart.this, Home.class);
            ...
            case R.id.action_dashboard:
                ...
                Intent intent_2 = new Intent(Performance_Chart.this, Dashboard.class);
            ...
            case R.id.action_profile:
                ...
                Intent intent_3 = new Intent(Performance_Chart.this, Profile.class);
