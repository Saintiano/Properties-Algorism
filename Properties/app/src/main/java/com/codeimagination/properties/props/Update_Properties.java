...
public class Update_Properties extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    private DatabaseReference databaseReference, databaseReferenceQuery;
    ...
    String property_UniqueKey;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update__properties);


        Intent intent = getIntent();

        final String userName = intent.getStringExtra(RecyclerViewAdapter_Create_Property.KEY_NAME);
        property_UniqueKey = intent.getStringExtra(RecyclerViewAdapter_Create_Property.UNIQUE_KEY);
        ...
        databaseReferenceQuery = firebaseDatabase.getReference("Selling_Created_Property");
        ...
        mView.setOnNavigationItemSelectedListener(Update_Properties.this);
        ...
        dbRefProperties = FirebaseDatabase.getInstance().getReference().child("Selling_Created_Property").child(property_UniqueKey);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()){
                    ...
                    //EditText
                    user_name_property.setText(property_username);
                    name_property_create.setText(property_name);
                    price_property_create.setText(property_price);

                    email_editProfile.setText(property_email);
                    mobile_number_editProfile.setText(property_phone_number);
                    date_of_create_editProfile.setText(property_timesCreated);
...
//                    }
    ...
    private void profilePicSelection() {
        ...
        final CharSequence[] items = {"Take Photo", "Choose from Library",
                "Cancel"};
        AlertDialog.Builder builder = new AlertDialog.Builder(Update_Properties.this);
    ...
    private void saveUserProfile() {
        ...
        if (!TextUtils.isEmpty(username) && !TextUtils.isEmpty(propertytName)) {
            ...
            if (imageHoldUri != null) {
                ...
                mUserDatabse = FirebaseDatabase.getInstance().getReference().child("Created_Property_Model").child(userId).child(property_UniqueKey);
                        ...
                        if (task.isSuccessful()) {
                            ...
                            dbRef.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onCancelled(@NonNull DatabaseError databaseError) {
                                    ...
                                    Toast.makeText(Update_Properties.this, " "+ databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(Update_Properties.this, "Property Updated", Toast.LENGTH_SHORT).show();


                            Intent moveToHome = new Intent(Update_Properties.this, View_Property.class);
                ...
                Toast.makeText(Update_Properties.this, "Please select a profile picture", Toast.LENGTH_LONG).show();

            }

        } else {

            Toast.makeText(Update_Properties.this, "Please enter Username and Property Name", Toast.LENGTH_LONG).show();
    ...
    private void checkAndRequestForPermission() {
        ...
        if (!(ContextCompat.checkSelfPermission(Update_Properties.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED)) {

            if (ActivityCompat.shouldShowRequestPermissionRationale(Update_Properties.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {

                Toast.makeText(Update_Properties.this, "Please accept to grant storage permission", Toast.LENGTH_SHORT).show();

            }else{

                ActivityCompat.requestPermissions(Update_Properties.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, PReqCode);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_home:
                ...
                Intent intent_1 = new Intent(Update_Properties.this, Home.class);
            ...
            case R.id.action_dashboard:
                ...
                Intent intent_2 = new Intent(Update_Properties.this, Dashboard.class);
            ...
            case R.id.action_profile:
                ...
                Intent intent_3 = new Intent(Update_Properties.this, Profile.class);
