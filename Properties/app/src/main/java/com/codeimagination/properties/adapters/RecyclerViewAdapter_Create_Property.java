...
public class RecyclerViewAdapter_Create_Property extends RecyclerView.Adapter<RecyclerViewAdapter_Create_Property.MyViewHolder>{
    ...
    public RecyclerViewAdapter_Create_Property(Context context, ArrayList<CreateProperty_Model> changeProviders) {
...
//
                Intent intent1 = new Intent(mContext, Property_Details.class); //ACTIVITY_NUM = 0
