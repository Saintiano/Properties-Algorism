...
import com.codeimagination.properties.props.Delete_Remove_Properties;
...
public class RecyclerViewAdapter_DeleteProperty extends RecyclerView.Adapter<RecyclerViewAdapter_DeleteProperty.MyViewHolder>{
    ...
    private DatabaseReference databaseReference, databaseCreated;

    public RecyclerViewAdapter_DeleteProperty(Context context, ArrayList<CreateProperty_Model> changeProviders) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, final int i) {
        ...
        final CreateProperty_Model createProperty_model = providers.get(i);
...
//
                Intent intent1 = new Intent(mContext, Delete_Remove_Properties.class); //ACTIVITY_NUM = 0
