...
public class View_Property extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    RecyclerViewAdapter_ViewProperty adapterCreateProperty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mView.setOnNavigationItemSelectedListener(View_Property.this);
        ...
        seller_recyclerview_linearlayout = findViewById(R.id.view_properties_recyclerview);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapterCreateProperty = new RecyclerViewAdapter_ViewProperty(View_Property.this, createProperty_models);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(View_Property.this, "No Data", Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_home:
                ...
                Intent intent_1 = new Intent(View_Property.this,Home.class);
            ...
            case R.id.action_dashboard:
                ...
                Intent intent_2 = new Intent(View_Property.this, Dashboard.class);
            ...
            case R.id.action_profile:
                ...
                Intent intent_3 = new Intent(View_Property.this, Profile.class);
